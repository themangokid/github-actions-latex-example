...
\newcommand{\ProcessAndRenderFile}[3][]{%
  ...
  \IfStrEq{\firstletter}{J}{%
    \lettrine[loversize=0.21, lines=3, lraise=0.22]{\firstletter}{\textsc{\MakeUppercase{\firstword}}} \remainingtext
  }{%
    \lettrine[loversize=0.3, lines=3, lraise=0.01]{\firstletter}{\textsc{\MakeUppercase{\firstword}}} \remainingtext
  }%
  \par
  \vspace{1cm}
