...
\maybeinput{render/GT/Första_Moseboken}     % 1 Mos.
\maybeinput{render/GT/Andra_Moseboken}       % 2 Mos.
\maybeinput{render/GT/Tredje_Moseboken}      % 3 Mos.
\maybeinput{render/GT/Fjärde_Moseboken}     % 4 Mos.
\maybeinput{render/GT/Femte_Moseboken}       % 5 Mos.
\maybeinput{render/GT/Josua}                 % Jos.
\maybeinput{render/GT/Domarboken}            % Dom.
\maybeinput{render/GT/Rut}                   % Rut
\maybeinput{render/GT/Första_Samuelsboken}  % 1 Sam.
\maybeinput{render/GT/Andra_Samuelsboken}    % 2 Sam.
\maybeinput{render/GT/Första_Kungaboken}    % 1 Kung.
\maybeinput{render/GT/Andra_Kungaboken}      % 2 Kung.
\maybeinput{render/GT/Första_Krönikeboken} % 1 Krön.
\maybeinput{render/GT/Andra_Krönikeboken}   % 2 Krön.
\maybeinput{render/GT/Esra}                  % Esra
\maybeinput{render/GT/Nehemja}               % Neh.
\maybeinput{render/GT/Ester}                 % Est. DONE
\maybeinput{render/GT/Job}                   % Job
\maybeinput{render/GT/Psaltaren}             % Ps.
\maybeinput{render/GT/Ordspråksboken}       % Ords.
\maybeinput{render/GT/Predikaren}            % Pred.
\maybeinput{render/GT/Höga_Visan}           % Hv.
\maybeinput{render/GT/Jesaja}                % Jes.
\maybeinput{render/GT/Jeremia}               % Jer.
\maybeinput{render/GT/Klagovisorna}          % Klag.
\maybeinput{render/GT/Hesekiel}              % Hes.
\maybeinput{render/GT/Daniel}                % Dan.
\maybeinput{render/GT/Hosea}                 % Hos.
\maybeinput{render/GT/Joel}                  % Joel
\maybeinput{render/GT/Amos}                  % Amos DONE
\maybeinput{render/GT/Obadja}                % Oba.
\maybeinput{render/GT/Jona}                  % Jona
\maybeinput{render/GT/Mika}                  % Mika
\maybeinput{render/GT/Nahum}                 % Nah.
\maybeinput{render/GT/Habackuk}              % Hab.
\maybeinput{render/GT/Sefanja}               % Sef.
\maybeinput{render/GT/Haggai}                % Hagg.
\maybeinput{render/GT/Sakarja}               % Sak.
\maybeinput{render/GT/Malaki}                % Mal.
